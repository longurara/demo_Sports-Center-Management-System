...
/** Avatar + tên + dòng phụ, dùng thống nhất trong các bảng. */
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
      ...
      <div style={{ minWidth: 0, lineHeight: 1.25 }}>
        ...
        <div style={{ fontSize: 12, color: '#64748b', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{sub ?? u.email}</div>
      </div>
    </div>
  );
}
