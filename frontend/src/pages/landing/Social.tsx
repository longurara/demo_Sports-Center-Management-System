    ...
    <section className="lp-section" id="pricing">
      <div className="lp-container">
        ...
        <Stagger className="lp-pricing">
          {plans.map((p, i) => (
            <Item key={p.id}>
              <div className={`lp-plan ${i === 1 ? 'hot' : ''}`}>
                {i === 1 && <span className="lp-plan-badge">Được chọn nhiều nhất</span>}
                ...
                <Link to="/register" className={`lp-btn ${i === 1 ? 'lp-btn-primary' : 'lp-btn-ghost'}`} style={{ width: '100%' }}>Đăng ký gói này</Link>
              </div>
            </Item>
          ))}
        </Stagger>
  ...
  return (
    <section ref={ref} className="lp-cta-wrap">
      <motion.div className="lp-cta" style={{ scale, borderRadius: radius }}>
        ...
        <div className="lp-container">
          <Reveal><h2 className="lp-cta-title">Tối nay <span className="lp-em">sân còn trống?</span></h2></Reveal>
